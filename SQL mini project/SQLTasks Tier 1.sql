...
SELECT DISTINCT f.name AS court, m.surname || ', ' || m.firstname AS member_name
FROM Bookings AS b
...
SELECT f.name AS facility, m.surname || ', ' || m.firstname AS member_name,
    CASE 
...
WHERE sub.starttime LIKE '2012-09-14%' AND sub.cost > 30
